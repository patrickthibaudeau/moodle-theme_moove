...
define(['jquery', 'core/log', 'core/config'], function ($, log, mdlcfg) {
    ...
    function init_sleekplan(){
      ...
              window.SLEEK_USER = {
              ...
              var sleekplanhtml = "<script type='text/javascript'>window.$sleek=[];window.SLEEK_PRODUCT_ID=" + mdlcfg.yorktasks_sleekplanproductid + ";(function(){d=document;s=d.createElement('script');s.src='https://client.sleekplan.com/sdk/e.js';s.async=1;d.getElementsByTagName('head')[0].appendChild(s);})();</script>";
